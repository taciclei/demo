...
class GenerateApiFeatureContext extends RestContext
{
    ...
    /**
     * @When I send a :method project request to :url where id is :node from last request
     */
    ...
    /**
     * @Given J'envoie une requete :method à :url où l'id est :node de la dernière requete
     */
    public function jenvoieUneRequeteAOuLidEstDeLaDerniereRequete($method, $url, $node)
    {
        return $this->iSendARequestWithIdFormLastRequest($method, $url, $node);
    }
